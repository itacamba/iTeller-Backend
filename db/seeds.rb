...
t3 = Transaction.create(account_id: a3.id, name: 'Electric Bill', amount: 180, category: "utilities", date: DateTime.new(2020,11,18), vendor: "Dominion Energy", note: "Purchase made every month", t_type: "expense")
